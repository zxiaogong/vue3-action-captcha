...
import { _ as _export_sfc } from "../app.ad1ea783.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Drag_captcha = resolveComponent("Drag-captcha");
  ...
  _push(ssrRenderComponent(_component_Drag_captcha, {
